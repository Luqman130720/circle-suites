...
<div>
    ...
    {{-- Profile Header --}}
    <div
        class="border-b border-slate-100 p-4 dark:border-slate-800">
        ...
        <div class="flex items-center gap-3">
            ...
            <div
                class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary text-sm font-bold text-white">
        ...
        <div class="mt-3 flex items-center gap-2">
            ...
            <span
                class="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-2 py-1 text-[10px] font-semibold text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400">
    ...
    <div
        ...
        <form
            ...
            <button
                ...
                <span
                    class="flex h-8 w-8 items-center justify-center rounded-lg bg-red-50 dark:bg-red-500/10">
